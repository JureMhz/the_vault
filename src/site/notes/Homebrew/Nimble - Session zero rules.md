---
{"dg-publish":true,"permalink":"/Homebrew/Nimble - Session zero rules/","dg-note-properties":{}}
---

- **Safety tools**: say “Pause for a minute”, everybody gets out of character, and resolves the issue of discomfort.
- **“I know a guy!” rule**: [link](https://youtu.be/q0eCR7OY95Q?t=1057) Basically, if the party needs someone with specific mundane knowledge or skill, one of them can say "*I know a guy…*" they tell the name and plausible location, then that person exists. The GM makes up relationships and other stuff. No guarantee that they will be favourably inclined. 
- **"I happened to have that thing" rule**: basically, if the party needs a mundane item, a player can declare possession with an explanation of where and why he/she has that item. GM can use WIL save if item is too exotic.
- **Identification:** Characters can use downtime to try to identify and attune to unindentified items. The way of tinkering with the object must align with the magical effect the object has, for identification to succeed. Unsuccessful tinkering still reveals something.
...
#### Healing and HP
- **Healing potions**:
	- Action: normal dice roll (Heal 2d4+4) *(avg: 7)*
	- 3 Actions: Heal max *(12)*
	- Can be given to another player. Player can use Reaction (or all three) to drink it.
